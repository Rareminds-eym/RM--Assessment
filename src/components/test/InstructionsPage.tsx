...
import { BookOpen, CheckCircle, AlertTriangle, Camera, Mic, MonitorX, Clock, Home, Timer } from 'lucide-react';
          ...
          <div className="p-6 sm:p-8">
            <div className="space-y-6">
              <div className="text-center">
                <h4 className="text-lg font-semibold text-gray-900 mb-2 font-serif">Welcome to the Test!</h4>
                <p className="text-gray-600">
                  This test will evaluate your understanding of the subject matter. Please read the instructions carefully before starting.
                </p>
              </div>
              ...
              <div className="border-l-4 border-blue-600 pl-4 py-2">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Total Duration: 60 minutes</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>First 50 minutes for answering questions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>Last 10 minutes reserved for review</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-5 h-5 text-yellow-500 mt-0.5 flex-shrink-0" />
                    <span>You will receive time warnings at:</span>
                  </li>
              ...
              {/* Quiz Format */}
              <div className="border-l-4 border-blue-600 pl-4 py-2">
                <h4 className="font-semibold text-gray-900 mb-2 font-serif">Test Format</h4>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="border-l-4 border-blue-600 pl-4 py-2">
                <h4 className="font-semibold text-gray-900 mb-2 font-serif">Proctoring Information</h4>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    <Camera className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>Camera access is required for proctoring purposes throughout the test</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Mic className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>Microphone access is required to monitor the testing environment</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <MonitorX className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>Switching tabs or opening other applications during the test is strictly prohibited</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span>Three violations of these rules will result in automatic test submission</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                <div className="flex items-start gap-2">
                  <AlertTriangle className="w-5 h-5 text-yellow-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-yellow-700 mb-1 font-serif">Important Notes</h4>
                    <ul className="space-y-1 text-yellow-700">
                      <li>• The test will automatically switch to review mode in the last 10 minutes</li>
                      <li>• The test will be automatically submitted when time expires</li>
                      <li>• Complete the test in one session - your progress will be lost if you close the browser</li>
